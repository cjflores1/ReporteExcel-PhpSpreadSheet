...
// $sheet->setCellValue('A1', 'UNIVERSIDAD MAYOR DE SAN ANDRES');
// $sheet->mergeCells('A1:H1');
// $sheet->getStyle('A1')->applyFromArray($styleArray);
// $sheet->setCellValue('A2', 'FACULTAD DE DERECHO Y CIENCIAS POLITICAS');
// $sheet->mergeCells('A2:H2');
// $sheet->getStyle('A2')->applyFromArray($styleArray1);
// $sheet->setCellValue('A3', 'UNIDAD DE POSTGRADO Y RELACIONES INTERNACIONALES');
// $sheet->mergeCells('A3:H3');
// $sheet->getStyle('A3')->applyFromArray($styleArray2);
// $sheet->setCellValue('A5', 'ACTA DE CALIFICACIONES');
// $sheet->mergeCells('A5:H5');
// $sheet->getStyle('A5')->applyFromArray($styleArray);

// $sheet->setCellValue('B7', 'AREA: ')->getStyle('B7')->applyFromArray($textBold);
// $sheet->setCellValue('B8', 'NIVEL: ')->getStyle('B8')->applyFromArray($textBold);
// $sheet->setCellValue('G8', 'GESTION: ')->getStyle('G8')->applyFromArray($textBold);
// $sheet->getRowDimension('9')->setRowHeight(28);
// $sheet->setCellValue('B9', 'PROGRAMA: ')->getStyle('B9')->applyFromArray($textBold);
// $sheet->setCellValue('G9', 'VERSION: ')->getStyle('G9')->applyFromArray($textBold);
// $sheet->getRowDimension('10')->setRowHeight(28);
// $sheet->setCellValue('B10', 'MODULO: ')->getStyle('B10')->applyFromArray($textBold);
// $sheet->setCellValue('G10', 'FECHA: ')->getStyle('G10')->applyFromArray($textBold);
// $sheet->setCellValue('B11', 'CATEDRATICO: ')->getStyle('B11')->applyFromArray($textBold);

// $sheet->getRowDimension('13')->setRowHeight(28);
// $sheet->setCellValue('A13', 'No.')->getStyle('A13')->applyFromArray($textBold1);
// $sheet->setCellValue('B13', 'APELLIDOS Y NOMBRES')->getStyle('B13:D13')->applyFromArray($textBold1);
// $sheet->mergeCells('B13:D13');
// $sheet->setCellValue('E13', 'CEDULA DE IDENTIDAD')->getStyle('E13')->applyFromArray($textBold1)->getAlignment()->setWrapText(true);
// $sheet->setCellValue('F13', 'CALIFICACION NUMERAL')->getStyle('F13')->applyFromArray($textBold1)->getAlignment()->setWrapText(true);
// $sheet->getRowDimension('10')->setRowHeight(25);
// $sheet->setCellValue('G13', 'CALIFICACION LITERAL')->getStyle('G13')->applyFromArray($textBold1)->getAlignment()->setWrapText(true);
// $sheet->getRowDimension('10')->setRowHeight(25);
// $sheet->setCellValue('H13', 'PONDERACION')->getStyle('H13')->applyFromArray($textBold1);
// $sheet->getStyle('A13:H13')->applyFromArray($styleArray2);
